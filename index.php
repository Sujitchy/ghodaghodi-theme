...
<section class="message-section" >
    ...
    <div class="message-content">
      <img src="assets/images/chairmanperson.jpg" alt="Chairperson" class="message-img">
  ...
  <!-- Our Partners Marquee Section -->
    <section class="partners-section" style="margin:40px 0;">
      ...
      <marquee behavior="scroll" direction="left" scrollamount="7" style="background:#f4f4f4;padding:1rem 0;">
        <img src="assets/images/usaid.jpg" alt="Partner 1" style="height:60px;margin:0 40px;vertical-align:middle;">
        <img src="assets/images/wwf.jpg" alt="Partner 2" style="height:60px;margin:0 40px;vertical-align:middle;">
        <img src="assets/images/care.jpg" alt="Partner 3" style="height:60px;margin:0 40px;vertical-align:middle;">
        <!-- <img src="assets/images/partner4.png" alt="Partner 4" style="height:60px;margin:0 40px;vertical-align:middle;"> -->
...
<section  class="gallery">
  ...
  <div class="gallery-grid">
    <div class="gallery-item">
      <img src="assets/images/tample.jpeg" alt="Gallery Image 1">
    </div>
    <div class="gallery-item">
      <img src="assets/images/tower.jpeg" alt="Gallery Image 2">
    </div>
    <div class="gallery-item">
      <img src="assets/images/boat.jpeg" alt="Gallery Image 3">
    </div>
    <!-- <div class="gallery-item">
